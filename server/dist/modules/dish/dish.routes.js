...
router.get('/:id', dish_controller_1.DishController.get);
router.post('/', dish_controller_1.DishController.create);
router.put('/:id', dish_controller_1.DishController.update);
router.delete('/:id', dish_controller_1.DishController.delete);
